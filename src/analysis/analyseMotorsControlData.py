...
if __name__ == "__main__":
    ...
    # Select data on log.
    for line in log:
        motor_data, input_data, desired_data, timestamp_data = mp.deserializeLogLineToData(line)
    ...
    mp.plotMultipleGraphs(timestamps, [inputs, motors, desired], ["PWM", "current rad/s", "desired rad/s"], formatted_datetime)
